...
Primeramente se importa la librería a utilizar y se comienzan a definir los parámetros que serán estudiados a continuación.
from scipy.fft import fft
...
Ahora se quiere ver lo calculado anteriormente 
De manera gráfica para poder estudiar y comprender el concepto
De densidad espectral de potencia en el presente proyecto
